...
-- ───────────────────────────────────────────────────────────────────────────
-- 4. TRIGGERS : cable fibre -> ports en OCCUPE
-- ───────────────────────────────────────────────────────────────────────────
...
-- ───────────────────────────────────────────────────────────────────────────
-- 5e. Gestion automatique de la capacite des cables
-- ───────────────────────────────────────────────────────────────────────────
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    ...
    IF v_dispo IS NULL THEN
      RAISE EXCEPTION 'Cable % introuvable', NEW.cable_id;
    END IF;
    IF NEW.capacite_gbps > v_dispo THEN
      RAISE EXCEPTION 'Capacite insuffisante sur le cable %', NEW.cable_id;
    END IF;
...
-- ───────────────────────────────────────────────────────────────────────────
-- 5f. Generation automatique du CID des services
-- ───────────────────────────────────────────────────────────────────────────
...
-- ───────────────────────────────────────────────────────────────────────────
-- 6. Fonction utilitaire : garantir les enfants minimaux
-- ───────────────────────────────────────────────────────────────────────────
